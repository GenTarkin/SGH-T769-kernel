...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_SCORCHED)
extern struct cpufreq_governor cpufreq_gov_scorched;
#define CPUFREQ_DEFAULT_GOVERNOR	(&cpufreq_gov_scorched)
