...
static struct clkctl_l2_speed l2_freq_tbl_v2[] = {
	...
	[21] = {1512000,  1, 0x1C, 1212500, 1250000, 5},
	[22] = {1566000,  1, 0x1D, 1212500, 1275000, 5},
	[23] = {1620000,  1, 0x1E, 1212500, 1275000, 5},
	[24] = {1728000,  1, 0x20, 1212500, 1275000, 5},
#else
	[20] = {1458000,  1, 0x1B, 1212500, 1275000, 3},
	[21] = {1512000,  1, 0x1C, 1212500, 1275000, 3},
	[22] = {1566000,  1, 0x1D, 1212500, 1275000, 3},
#endif
                                              };
...
static struct clkctl_acpu_speed acpu_freq_tbl_fast[] = {
	...
	{ {1, 1}, 1620000,  ACPU_SCPLL, 0, 0, 1, 0x1E, L2(21), 1175000, 0x03006000},
	{ {1, 1}, 1674000,  ACPU_SCPLL, 0, 0, 1, 0x1F, L2(21), 1200000, 0x03006000},
	{ {1, 1}, 1728000,  ACPU_SCPLL, 0, 0, 1, 0x20, L2(22), 1225000, 0x03006000},
	{ {1, 1}, 1782000,  ACPU_SCPLL, 0, 0, 1, 0x21, L2(23), 1250000, 0x03006000},
