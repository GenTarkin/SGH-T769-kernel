...
static struct clkctl_l2_speed l2_freq_tbl_v2[] = {
	...
	[23] = {1620000,  1, 0x1E, 1212500, 1250000, 4},
	[24] = {1728000,  1, 0x20, 1212500, 1275000, 4},
#else
	[20] = {1458000,  1, 0x1B, 1212500, 1250000, 3},
	[21] = {1512000,  1, 0x1C, 1212500, 1250000, 3},
	[22] = {1566000,  1, 0x1D, 1212500, 1250000, 3},
	[23] = {1620000,  1, 0x1E, 1212500, 1250000, 3},
#endif
                                              };
...
static struct clkctl_acpu_speed acpu_freq_tbl_fast[] = {
	...
	{ {1, 1}, 1836000,  ACPU_SCPLL, 0, 0, 1, 0x22, L2(23), 1275000, 0x03006000},
#else
	{ {1, 1}, 1566000,  ACPU_SCPLL, 0, 0, 1, 0x1D, L2(20), 1150000, 0x03006000},
